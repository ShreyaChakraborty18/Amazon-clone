                    ...
                    <div className='payment__details'>
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className='payment__priceContainer'>
                                ...
                                <button className='final__button' disabled={processing || disabled || succeeded} onClick={handlePayment, handlebutton}>
                                    <span>{processing ? <p>Processing</p> : "Buy Now"}</span>
                                </button>
                                ...
                                <button className='final__button' disabled={disabled | succeeded} onClick={handlePayment, e => navigate('/confirm')}>
                                    <span>Preceed to Confirmation Page</span>
                                </button>
                            </div>
